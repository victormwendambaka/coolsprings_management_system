				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT tblbooking.BookingId as bookid,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tbltourpackages.PackageName as pckname,tblbooking.PackageId as pid,tblbooking.FromDate as fdate,tblbooking.ToDate as tdate,tblbooking.Comment as comment,tblbooking.status as status,tblbooking.CancelledBy as cancelby,tblbooking.roomsbooked as bookedrooms,tblbooking.Totalprice as total,tblbooking.UpdationDate as upddate from  tblbooking
...
{				?>		
					...
					<td><?php echo htmlentities($result->fdate);?> To <?php echo htmlentities($result->tdate);?></td>
						...
						<td><?php echo htmlentities($result->total);?>
						</td>
