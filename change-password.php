...
else
{
    ...
    {
        // Hash the current password using MD5 (note: MD5 is cryptographically weak)
        ...
        // SQL query to verify current password matches database record
        ...
        // Check if current password is correct (at least one row returned)
        if($query->rowCount() > 0)
        {
        ...
        {
            // Set error message if current password doesn't match
...
<div class="privacy">
    <div class="container">
        ...
        <!-- Password change form with client-side validation -->
